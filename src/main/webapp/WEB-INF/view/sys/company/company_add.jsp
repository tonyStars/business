        ...
        <form class="layui-form" id="customForm">
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="companyCode" lay-verify="required" placeholder="请输入公司编码" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">公司全称</label>
                    <div class="layui-input-inline">
                        <input type="text" name="companyName" lay-verify="required" placeholder="请输入公司全称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="text" id="parentName" name="parentName" placeholder="请选择父公司" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="contactPhone" placeholder="请输入联系电话" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" >
                        ...
                        <input type="text" name="addressNames" id="addressNames" lay-verify="required" placeholder="请选择省市区" autocomplete="off" class="layui-input" readonly>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="nameShort" placeholder="请输入公司简称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
...
<script>
    layui.use(['form', 'layer','tableSelect'], function () {
        ...
        renerSelectByData($("#typeCode"),parent.TYPE_CODE);
        renerSelectByData($("#companyLevel"),parent.COMPANY_LEVEL);
        tableSelect.render({
            elem: '#parentName',

        ...
        <form class="layui-form" id="customForm">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="blueNumber6" value="${model.blueNumber6}" lay-verify="required" placeholder="请输入蓝号码6" autocomplete="off" class="layui-input" onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'')" maxlength='2'>
                    </div>
                </div>
                <div class="layui-inline">
